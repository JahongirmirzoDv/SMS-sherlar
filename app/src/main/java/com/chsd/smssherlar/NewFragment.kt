...
class NewFragment : Fragment(), DD {
    ...
    override fun onCreateView(
        ...
        root.back_btnn.setOnClickListener {
        ...
        root.rv_new.adapter = smsAdapter
        ...
        list.add(
            SMS(
                ...
                "Yangi kun keltirsin baht, omad, quvonch,\n" +
                        ...
                        "Yangi yilingiz qutlug’ bo’lsin,\n" +
                        "Nomingiz bundanda ulug’ bo’lsin.\n" +
                        "Nimak niyat qilgan bo’lsangiz,\n" +
                        "Iloyim barchasi amalga oshshisin!\n" +
        ...
        list.add(
            SMS(
                ...
                "    .*.\n" +
                        ...
                        " *._.*_2_*_.*\n" +
                        "*._.*.***.*._.*\n" +
                        "/ \\ YANGI YIL! Omad va Baxt olib kelsin !!!\n" +
                        "Kirib kelayotgan 2022-yil sizga: Towkent taxtini," +
                        "Buxoro baxtini, Samarqand saroyini, Farg'ona chiroyini," +
                        " Namangan gullarini, AQSH ning pullarini olib kelsin."
            )
        )
        list.add(
            SMS(
                "YANGI YIL TABRIGI",
                "Yakinlashib kelayotgan Yangi Yil yaxshiliklarka boy bulsin!" +
                        " Xamma insonlar yaxshi niyatlariga erishsin orzulari amalga oshsin."
            )
        )
        list.add(
            SMS(
